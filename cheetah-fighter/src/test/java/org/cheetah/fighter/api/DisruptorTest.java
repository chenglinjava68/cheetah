...
public class DisruptorTest {
    ...
    public void test() {
        ...
        Handler handler = DomainEventHandlerFactory.getDomainEventHandlerFactory().createDomainEventHandler();
        handler.registerEventListener(new SmartDomainListenerTest2());
