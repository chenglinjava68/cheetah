...
import cheetah.dispatcher.governor.support.AkkaGovernor;
import cheetah.dispatcher.governor.support.WorkerMaster;
...
public class DefaultEngine implements Engine {
    ...
    public void start() {
        if (!isRunning()) {
            ...
            workerGovernor = actorSystem.actorOf(Props.create(WorkerMaster.class).withDispatcher("dispatcher"), actorGovernorName);
