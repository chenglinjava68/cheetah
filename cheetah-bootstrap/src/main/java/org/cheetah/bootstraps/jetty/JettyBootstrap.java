...
public class JettyBootstrap extends BootstrapSupport {
     ...
     * 当如果只是提供单纯的rest接口时，即仅是提供RPC功能，没有任何的页面也不使用web.xml，
    ...
    protected void startup() throws Exception {
        try {
            ...
            server.start();
            Warn.log(JettyBootstrap.class, "Launch configuration source from {}, Server Mode: {}", envConfigSource ? "env":"a file", webMode ? "web" : "Rest");
