...
public interface PathMatcher {
     ...
     * <p>If the return value is {@code false}, then the {@link #matches}
     ...
     * path goes, assuming that a full path may then matches as well.
     *
     * @param pattern the pattern to matches against
     * @param path    the path String to test
     * @return {@code true} if the supplied {@code path} matched,
     * {@code false} if it didn't
     */
    boolean matchesStart(String pattern, String path);
     ...
     * (never {@code null})
     */
    String extractPath(String pattern, String path);
     ...
     */
    Map<String, String> extractPathVariables(String pattern, String path);
