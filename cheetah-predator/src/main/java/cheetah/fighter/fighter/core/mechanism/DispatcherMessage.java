package cheetah.fighter.fighter.core.mechanism;
 ...
 */
public class DispatcherMessage extends SimpleChannelInboundHandler<Message> implements cheetah.fighter.fighter.core.Dispatcher {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        cheetah.fighter.commons.logger.Error.log(this.getClass(), cause.getMessage());
        ctx.close();
    }
